...
ActiveRecord::Schema[8.0].define(version: 2025_07_29_100749) do
  ...
  create_table "lesson_progresses", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["section_id"], name: "index_lesson_progresses_on_section_id"
  end
